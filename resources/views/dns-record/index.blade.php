...
<p>DNS records for {{ $records->first()->domain->domain_name ?? 'Domain' }}</p>
...
<input type="text" name="value" id="form_value"
       value="{{ old('value') }}"
...
<input type="text"
       name="external_ip"
       id="form_external_ip"
       value="{{ old('external_ip') }}"
       placeholder="e.g. 85.105.10.25"
       autocomplete="off">
...
hostInput.placeholder = "e.g. @ or www";
...
valueInput.placeholder = "e.g. 2001:db8::1";
...
valueInput.placeholder = "e.g. ns1.example.com";
...
valueInput.placeholder = 'e.g. v=spf1 include:_spf.google.com ~all';
